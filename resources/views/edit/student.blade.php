      ...
      <tbody id="students-list">
          ...
          <tr>
              ...
              <td>
                  ...
                  <button type="button" class="btn btn-primary" id="edit" data-id="{{ $student->id }}"><i class="fa fa-edit"></i></button>
                  <button type="button" class="btn btn-danger" id="delete" data-id="{{ $student->id }}"><i class="fa fa-trash"></i></button>
                  </div>
              </td>
          </tr>
          @endforeach
